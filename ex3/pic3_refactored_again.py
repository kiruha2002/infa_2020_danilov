...
def draw_background(width, height):
    '''
        function draws background (rectangle width * height)

        
        Parameters
        ---------
        2 components int, int
        width, heighr -- width and height of it
...
def draw_person(width, height, radius, gender, hands_types, x, y):
    '''
        ...
        Parameters
        ---------
        7 components int, int, int, int ,tuple (int, int), int, int
...
def draw_ice_cream(width, height, color0, color1, color2, color3, x, y):
    '''
        ...
        Parameters
        ----------
        8 coponents int, int, tuple(int, int, int), tuple (int, int, int),
...
def draw_heart(width, height, color, x, y):
    '''
        ...
        Paramters
        ---------
        5 components int, int, tuple(int, int, int), int, int
